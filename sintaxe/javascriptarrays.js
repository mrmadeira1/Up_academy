...
// Copy array
const arrayInitSame = [1, 2, 3];
const arrayInitComp = [1, {a1: 1}, 3];

// const copyArrayInitSame = arrayInitSame; // Cuidado
// const copyArrayInitComp = arrayInitComp; // Cuidado

// const copyArrayInitSame = arrayInitSame.slice();
// const copyArrayInitComp = arrayInitComp.slice(); // Cuidado

// const copyArrayInitSame = Object.assign([], arrayInitSame);
// const copyArrayInitComp = Object.assign([], arrayInitComp); // Cuidado

// const copyArrayInitSame = [...arrayInitSame];
// const copyArrayInitComp = [...arrayInitComp]; // Cuidado

// const copyArrayInitSame = JSON.parse(JSON.stringify(arrayInitSame));
// const copyArrayInitComp = JSON.parse(JSON.stringify(arrayInitComp));

// copyArrayInitSame.push(4);
// console.log("arrayInitSame     :", arrayInitSame);
// console.log("copyArrayInitSame :", copyArrayInitSame);
