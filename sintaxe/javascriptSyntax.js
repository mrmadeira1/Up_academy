...
let firstName = "Zé";
let lastNAme = "Carlos"
let fullNameLiteral = `${firstName} ${lastNAme}`
...
let lastName = "Carlos";                          // String
let x = {firstName: "Zé", lastName: "Carlos"};  // Object
...
// Diff
function fRegularRoot(a) {
  debugger
  console.log("In Regular : ", a, this);
}

let app = {
  a: 5,
  fRegular(a) {
    console.log("In Regular : ", a, this.a);
  },
  fArrow: (a) => {
    console.log("In Arrow : ", a, this.a);
  }
}
app.fRegular(10);
app.fArrow(10)
...
// Ternary expression
// It's an equivalent to an if/else construct that returns a value. 
// An if/else clause is code, a ternary expression is an expression, meaning that it returns a value.
